...
**Preview Text:** Your 30-day free trial is active. Let's make it count.
...
Add your shop name, location, and currency. This personalizes your dashboard and receipts.

**Step 2: Add your products** (5-10 minutes)
Start with your top 20 best-sellers. You can add the rest later. For each product, you need: name, selling price, and how many units you have in stock.
...
**Subject Line:** Make your first sale on QuadERP (it takes 30 seconds) 💰

**Alternative Subject Line:** Ready? Let's ring up your first sale.

**Preview Text:** Search → Add → Pay → Done. Let's walk through it together.
...
Every sale you process through QuadERP is a sale you'll never lose track of.

**[Process Your First Sale →]** (Links to: https://app.quaderp.app/pos)

Try it today. Once you see how fast and clean it is, you won't want to go back to the book.
...
**Subject Line:** The feature that pays for itself (and no other system has it) 🔒

**Alternative Subject Line:** Are you sure nothing is going missing in your shop?

**Preview Text:** QuadERP catches theft patterns that your eyes can't see. Here's how.
...
Quick question: how confident are you that every cedi in your shop is accounted for?
...
No other retail management system in Ghana offers this level of automated loss detection.

**[Explore Loss Prevention →]** (Links to: https://app.quaderp.app/loss-prevention)

You may not have a problem. But wouldn't you rather know for sure?
...
**Preview Text:** Real results from real businesses in Ghana.
...
💬 **Grace, Pharmacy Owner, Osu:**
"I was losing GHS 2,400 every month to theft I couldn't see. QuadERP caught the pattern in 2 weeks. I've saved over GHS 28,000 this year."

💬 **Kofi, Mini-Mart Owner, Tema:**
"My cashier used to tell me 'sales were slow.' Now I open QuadERP and see the real numbers. I manage with data, not stories."

💬 **Abigail, Beauty Supply, 3 locations:**
"I had GHS 14,000 of dead stock in one branch while another branch needed the same products. QuadERP showed me in the first week."

💬 **Nana Yaw, Hardware Store, Kumasi:**
"I used to spend my Sundays doing stocktake. Now it takes 2 hours on Saturday morning. I got my weekends back."
...
**[Open Your Dashboard →]** (Links to: https://app.quaderp.app/dashboard)

Need help getting the most out of your trial? Reply to this email or WhatsApp us at [Number]. We're here.
...
**Preview Text:** Don't lose your data, your reports, or your loss prevention alerts.
...
Your 30-day free trial ends **tomorrow**.

Here's what that means:

If you subscribe, **nothing changes.** Your data stays. Your products stay. Your reports stay. Your staff accounts stay. Everything continues seamlessly.
...
- **A/B testing:** Test the alternative subject lines. Measure open rates. Test the Email 5 promo code (STAYWITHUS) vs. no promo code to measure conversion lift vs. revenue impact.
- **Suppression rules:**
  - Don't send Email 5 if the user has already subscribed
  - Don't send any emails if the user has been inactive for 10+ days (move them to a re-engagement sequence instead)
  - If the user replies to any email with a question or objection, pause the automation and route to a human (sales rep or support)
- **WhatsApp backup:** For users who don't open emails (common in Ghana), send a shortened version of Email 3 (loss prevention) and Email 5 (trial expiring) via WhatsApp or SMS as backup touchpoints.
- **Metrics to track:** Open rate, click-through rate, reply rate, and most importantly: trial-to-paid conversion rate segmented by email engagement (opened all 5, opened some, opened none).
