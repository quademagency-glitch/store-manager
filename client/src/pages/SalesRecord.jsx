            ...
            <>
              {canReturn && selectedReceiptSale.status !== 'voided' && selectedReceiptSale.return_status !== 'full' && (
                <button 
                  ...
                  style={{ background: 'rgba(245, 158, 11, 0.1)', color: '#f59e0b', border: '1px solid rgba(245, 158, 11, 0.3)', padding: '10px 16px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '6px' }}
                >
              ...
              {hasPermission('manage_business') && (
                <button 
                  ...
                  disabled={isProcessing}
                  style={{ background: 'rgba(239, 68, 68, 0.1)', color: '#ef4444', border: '1px solid rgba(239, 68, 68, 0.3)', padding: '10px 16px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '6px' }}
                >
