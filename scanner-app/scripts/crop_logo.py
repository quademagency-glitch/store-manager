...
if __name__ == "__main__":
    input_file = "/Volumes/QUADEM/VIBE CODING/Quadem Digital Enterprise/public/images/logo.png"
    base_dir = "/Volumes/QUADEM/VIBE CODING/ERP/scanner-app/assets/images"
    ...
    crop_logo(input_file, android_fg_file, android_fg_file)
