...
const FROM_EMAIL = process.env.FROM_EMAIL || 'billing@quaderp.app'; // Use verified domain in production
          ...
          <tr>
            <td style="background:#f8fafc;padding:24px 40px;border-top:1px solid #e2e8f0;">
              <p style="margin:0;color:#94a3b8;font-size:12px;text-align:center;">
                This invoice was generated by ${PLATFORM_NAME}. You can also view and print your full invoice from your dashboard.<br/>If you have questions, contact us at ${PLATFORM_ADMIN_EMAIL || 'billing@quaderp.app'}.
              </p>
            </td>
          </tr>
